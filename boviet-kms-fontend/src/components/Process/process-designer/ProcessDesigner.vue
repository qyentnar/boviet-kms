<template>
  <div class="my-process-designer">
    ...
    >
    <div v-highlightjs>
      <el-link :underline="false" icon="el-icon-document-copy" v-clipboard:copy="previewResult" v-clipboard:success="clipboardSuccess" style="position: absolute; top: 60px;">复制</el-link>
          <pre>
            <code>
              {{previewResult}}
            </code>
